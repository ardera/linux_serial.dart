...
class LibCInternal32 {
  /// Holds the Dynamic library.
  final ffi.DynamicLibrary _dylib;

  /// The symbols are looked up in [dynamicLibrary].
  LibCInternal32(ffi.DynamicLibrary dynamicLibrary) : _dylib = dynamicLibrary;
...
typedef _c_read = ffi.Int32 Function(
  ffi.Int32 __fd,
  ffi.Pointer<ffi.Void> __buf,
  ffi.Uint32 __nbytes,
);
...
typedef _c_write = ffi.Int32 Function(
  ffi.Int32 __fd,
  ffi.Pointer<ffi.Void> __buf,
  ffi.Uint32 __n,
);
